...
interface MemberParameter {
  daoAddress: string;
}

const Member = (props: MemberParameter) => {
  ...
  return (
    <>
      ...
      {showList == true && (
        <div>
          <MemberList
            setShowElectionButton={setShowSelectElectionButton}
            setShowMemberButton={setShowMemberButton}
            daoAddress={props.daoAddress}
          ></MemberList>
        </div>
      )}
      {showAddMember == true && (
        <AddMember daoAddress={props.daoAddress}></AddMember>
      )}
      {showSelectElection == true && (
        <SelectElectionComission
          daoAddress={props.daoAddress}
        ></SelectElectionComission>
      )}
    </>
